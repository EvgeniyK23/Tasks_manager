# Form implementation generated from reading ui file 'C:\Projects\tasks_manager\tasks_manager_greenatom\general_code\tasker.ui'
#
...
class Ui_Tasker(object):
    def setupUi(self, Tasker):
        ...
        self.add_task.setStyleSheet("background-color: rgb(0, 255, 0);\n"
        ...
        self.delete_id.setStyleSheet("background-color: rgb(255, 0, 255);\n"
                                     "font: 75 16pt \"Arial\";")
        ...
        self.delete_id_in.setStyleSheet("background-color: rgb(255, 0, 255);\n"
                                        "font: 75 16pt \"Arial\";")
    ...
    def retranslateUi(self, Tasker):
        ...
        Tasker.setWindowTitle(_translate("Tasker", "MainWindow"))
        self.fullname.setText(_translate("Tasker", "ФИО пользователя"))
        self.name.setText(_translate("Tasker", "Название задачи"))
        self.descript.setText(_translate("Tasker", "Описание"))
        self.priority.setText(_translate("Tasker", "Приоритетность"))
        self.deadline.setText(_translate("Tasker", "Срок"))
        self.add_task.setText(_translate("Tasker", "Запись в БД"))
        self.get_all.setText(_translate("Tasker", "Выгрузить из БД"))
        self.delete_2.setText(_translate("Tasker", "УДАЛИТЬ БД"))
        self.sort_fullname.setText(_translate("Tasker", "По ФИО"))
        self.sort_name.setText(_translate("Tasker", "По \n"
                                                    "названию\n"
                                                    "задачи"))
        self.sort_deadline.setText(_translate("Tasker", "По\n"
                                                        " DEADLINE"))
        self.label.setText(_translate("Tasker", "Сортировка"))
        self.label_2.setText(_translate("Tasker", "Поиск"))
        self.search_name.setText(_translate("Tasker", "По \n"
                                                      "названию\n"
                                                      "задачи"))
        self.search_deadline.setText(_translate("Tasker", "По\n"
                                                          " DEADLINE"))
        self.search_fullname.setText(_translate("Tasker", "По ФИО"))
        self.delete_id.setText(_translate("Tasker", "Удалить по ID"))
        self.delete_id_in.setText(_translate("Tasker", ""))
        self.search_fullname_in.setText(_translate("Tasker", ""))
